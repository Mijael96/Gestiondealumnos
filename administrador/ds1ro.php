...
$consulta=$baseDeDatos->prepare('SELECT * from alumnos where Id_carrera="2" and 	Id_anio="1"');
$consulta->execute();
...
$consulta1=$baseDeDatos->prepare('SELECT * from alumnos where Id_carrera="2" and 	Id_anio="1" and Id_Comision="2" ORDER BY Apellido ASC');
$primeroSegunda= $consulta1->execute();
$primeroSegunda=$consulta1->fetchAll(PDO::FETCH_ASSOC);

$consulta2=$baseDeDatos->prepare('SELECT * from alumnos where Id_carrera="2" and 	Id_anio="1" and Id_Comision="3" ORDER BY Apellido ASC');
...
?>
  ...
  <?php $consulta1=$baseDeDatos->prepare('SELECT * from alumnos where Id_carrera="2" and 	Id_anio="1" and Id_Comision="1" ORDER BY Apellido ASC');
        $consulta1->execute();
...
<?php if (!empty($primeroSegunda)): ?>
  ...
  <?php $contador=1; foreach ($primeroSegunda as $value): ?>
    <?php if ($value["Id_carrera"]=="2" && $value["Id_anio"]=="1" && $value["Id_Comision"]=="2" ): ?>
...
<?php if (!empty($primeroTercera)): ?>
  ...
  <?php $contador=1; foreach ($primeroTercera as $value): ?>
    <?php if ($value["Id_carrera"]=="2" && $value["Id_anio"]=="1" && $value["Id_Comision"]=="3" ): ?>
