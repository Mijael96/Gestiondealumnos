...
$consulta=$baseDeDatos->prepare('SELECT * from alumnos where Id_carrera="2" and 	Id_anio="2"');
$consulta->execute();
...
$consulta1=$baseDeDatos->prepare('SELECT * from alumnos where Id_carrera="2" and 	Id_anio="2" and Id_Comision="2" ORDER BY Apellido ASC');
$primeroSegunda= $consulta1->execute();
$primeroSegunda=$consulta1->fetchAll(PDO::FETCH_ASSOC);

$consulta2=$baseDeDatos->prepare('SELECT * from alumnos where Id_carrera="2" and 	Id_anio="2" and Id_Comision="3" ORDER BY Apellido ASC');
...
?>
    ...
    <div class="container">
        <br>
      <h3 style="text-align: center;">2do 1ra</h3>
      <br>
  ...
  <?php $consulta1=$baseDeDatos->prepare('SELECT * from alumnos where Id_carrera="2" and 	Id_anio="2" and Id_Comision="1" ORDER BY Apellido ASC');
        $consulta1->execute();
...
<?php if (!empty($primeroSegunda)): ?>
      <h3 style="text-align: center;">2do 2da</h3>
      <br>
      <table class="table table-bordered">
  <thead>
    <tr>
  ...
  <?php $contador=1; foreach ($primeroSegunda as $value): ?>
    <?php if ($value["Id_carrera"]=="2" && $value["Id_anio"]=="2" && $value["Id_Comision"]=="2" ): ?>
...
<?php if (!empty($primeroTercera)): ?>
      <h3 style="text-align: center;">2do 3ra</h3>
      <br>
      <table class="table table-bordered">
  <thead>
    <tr>
  ...
  <?php $contador=1; foreach ($primeroTercera as $value): ?>
    <?php if ($value["Id_carrera"]=="2" && $value["Id_anio"]=="2" && $value["Id_Comision"]=="3" ): ?>
